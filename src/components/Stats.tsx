...
const stats = [
  { value: 120, suffix: "", desc: "Water Projects Completed Across Imo State" },
  { value: 350, suffix: "", desc: "Communities with Improved Water Access" },
  { value: 5000, suffix: "+", desc: "Sanitation Facilities Provided" },
  { value: 200, suffix: "M+", desc: "Liters of Clean Water Supplied" },
];
