...
const info = {
    ...
    description: "The Imo State Ministry of Water Resources was created by the administration of His Excellency, Distinguished Senator Hope Uzodinma: the Governor of Imo State to facilitate the transformation of Imo State ",
    quickLinks: [
        {
            label: "Projects",
            href: "/projects" 
    ...
    contact: [
        ...
        },
        {
            ...
            href: "mailto:ministryofwater.imo@gmail.com"
        },  
        {
            label: "P.M.B 1146 Ugwu Orji, Okigwe Road, Owerri, Imo State.",
            href: "/"
        },
    ]
}
