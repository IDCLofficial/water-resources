...
export const TopHero = ({ ministryName, titleLabel }: TopHeroProps) => {
    return (
        <div className="relative h-[40vh] sm:h-[50vh] px-4 sm:px-8 md:px-[3rem] py-10 flex flex-col justify-center bg-gradient-to-r from-green-900/20 via-black to-black">
