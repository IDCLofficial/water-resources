...
export default function AboutUs() {
    return (
        <div className="h-screen bg-white">
            ...
            {/* Section Hero */}
            <SectionHero
                aboutText="The Ministry of Water Resources in Imo State serves as a vital engine for public health and economic transformation, especially as the state seeks to ensure sustainable water access. While there's still room for growth and reform, the ministry represents a key opportunity for clean water provision and sustainable development in Imo State. The Ministry of Water Resources in Imo State is a government agency responsible for promoting water infrastructure development and regulating water resources within the state. It is a strategic part of the state's development plan, especially considering Imo's water resource base. The ministry was likely formed from a merger or restructuring of previous departments such as the Ministry of Water, Environment, and sections of Natural Resources or Water Management units. Over the years, successive governments in Imo State have recognized the importance of harnessing local water resources like rivers, lakes, and groundwater, which are abundant in the region."
